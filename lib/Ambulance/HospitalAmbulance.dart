...
class HospitalAmbulance extends StatefulWidget {
  @override
  State<HospitalAmbulance> createState() => _HospitalAmbulanceState();
}

class _HospitalAmbulanceState extends State<HospitalAmbulance> {
  late final Stream<QuerySnapshot> _HospitalAmbulanceStream;

  @override
  void initState() {
    super.initState();
    _HospitalAmbulanceStream = FirebaseFirestore.instance
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: _HospitalAmbulanceStream,
